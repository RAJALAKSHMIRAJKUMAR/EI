...
BEGIN
	...
	T.PD_COMMENTS,ULD.ULD_ID,T.PD_TIMESTAMP FROM ',DESTINATIONSCHEMA,'.TEMP_PAYMENT_ENTRY_DETAILS T,',DESTINATIONSCHEMA,'.USER_LOGIN_DETAILS ULD WHERE ULD.ULD_LOGINID=T.PD_USERSTAMP)'));
