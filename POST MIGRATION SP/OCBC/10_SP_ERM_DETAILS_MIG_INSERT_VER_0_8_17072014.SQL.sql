...
BEGIN
	...
	SET @CREATE_ERM_OCCUPATION_DETAILS=(SELECT CONCAT('CREATE TABLE ',DESTINATIONSCHEMA,'.ERM_OCCUPATION_DETAILS(
	ERMO_ID INTEGER NOT NULL AUTO_INCREMENT,
	ERMO_DATA VARCHAR(40) UNIQUE NOT NULL,
	...
	SET @CREATE_ERM_ENTRY_DETAILS=(SELECT CONCAT('CREATE TABLE ',DESTINATIONSCHEMA,'.ERM_ENTRY_DETAILS(
	...
	ERM_CONTACT_NO VARCHAR(20) NULL, 
	...
	PRIMARY KEY(ERM_ID), 
	FOREIGN KEY(ERMO_ID) REFERENCES ',DESTINATIONSCHEMA,'.ERM_OCCUPATION_DETAILS (ERMO_ID), 
	FOREIGN KEY(ULD_ID) REFERENCES ',DESTINATIONSCHEMA,'.USER_LOGIN_DETAILS(ULD_ID))'));
	...
	ERMO_ID VARCHAR(40) NOT NULL,NC_SNO VARCHAR(40)NULL,ERM_NO_OF_GUESTS VARCHAR(10)NULL,ERM_AGE VARCHAR(10)NULL,ERM_CONTACT_NO VARCHAR(20)NULL,
	...
	COMMIT;
END;
CALL SP_ERM_DETAILS_MIG_INSERT(SOURCESCHEMA,DESTINATIONSCHEMA,MIGUSERSTAMP);