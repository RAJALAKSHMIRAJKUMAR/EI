...
BEGIN
 ROLLBACK; 
 IF (CHARTS_INTERMEDIATE_PERSONAL_NET_REVENUE_TMPTBL IS NOT NULL) THEN
   ...
   END IF;   
IF (CHARTS_GROSS_REVENUE IS NOT NULL) THEN
  ...
  END IF;  
 IF (CHARTS_UNIT_RENTAL IS NOT NULL) THEN 
  ...
  END IF;  
IF (CHARTS_BIZ_EXPENSE IS NOT NULL) THEN    
  ...
  END IF;  
IF (CHARTS_STAFF_EXPENSE IS NOT NULL) THEN  
  ...
  END IF;  
IF (CHARTS_PERSONAL_EXPENSE IS NOT NULL) THEN  
...
CALL SP_CHARTS_STAFF_EXPENSE(FROM_DATE , TO_DATE,USERSTAMP,@TEMP_CHARTS_STAFF_EXPENSE);
 ...
 CREATE OR REPLACE VIEW VIEW_NET_REVENUE AS
    ...
    RIGHT JOIN VIEW_TOTAL_RENTAL_EXPENSE t2 ON t1.MONTH_YEAR = t2.MONTH_YEAR;    
    		SET @CREATE_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE=(SELECT CONCAT('CREATE TABLE ',CHARTS_INTERMEDIATE_PERSONAL_NET_REVENUE_TMPTBL,'(MONTH_YEAR VARCHAR(20), GROSS_REVENUE DECIMAL(10,2) DEFAULT 0,TOT_RENTAL_EXPENSE DECIMAL(10,2) DEFAULT 0,
		NET_REVENUE DECIMAL(10,2) DEFAULT 0, UNIT_RENTAL INT DEFAULT 0, TOT_BIZ_EXPENSE DECIMAL(10,2) DEFAULT 0, TOT_STAFF_EXPENSE DECIMAL(10,2) DEFAULT 0, TOT_PERSONAL_EXPENSE DECIMAL(10,2) DEFAULT 0, SORT_DATE DATE)'));
		...
		PREPARE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT FROM @INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE;
		EXECUTE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT;
		SET @INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE=(SELECT CONCAT('INSERT INTO ',CHARTS_INTERMEDIATE_PERSONAL_NET_REVENUE_TMPTBL,' (MONTH_YEAR, TOT_STAFF_EXPENSE, SORT_DATE) (SELECT MONTH_YEAR,TOTAL_STAFF_EXP, str_to_date(concat(''1-'', SUBSTRING(MONTH_YEAR,1,3) ,''-'', SUBSTRING_INDEX(MONTH_YEAR,''-'',-1)),  ''%d-%b-%Y'') FROM VIEW_CHARTS_TOTAL_STAFF_EXPENSE)'));
		PREPARE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT FROM @INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE;
		EXECUTE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT;
		...
		PREPARE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT FROM @INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE;
		EXECUTE INSERT_TEMP_INTERMEDIATE_PERSONAL_NET_REVENUE_STMT;
		SET @CREATE_TEMP_CHARTS_PERSONAL_NET_REVENUE=(SELECT CONCAT('CREATE TABLE ',CHARTS_PERSONAL_NET_REVENUE_TMPTBL,'(MONTH_YEAR VARCHAR(20), GROSS_REVENUE DECIMAL(10,2),TOT_RENTAL_EXPENSE DECIMAL(10,2),
		NET_REVENUE DECIMAL(10,2), UNIT_RENTAL INT, TOT_BIZ_EXPENSE DECIMAL(10,2), TOT_STAFF_EXPENSE DECIMAL(10,2), TOT_PERSONAL_EXPENSE DECIMAL(10,2))'));
