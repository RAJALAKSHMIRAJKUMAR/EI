...
BEGIN
	...
	SET CHART_INTERMEDIATE_PERSONAL_EXPENSE_TMPTBL=(SELECT CONCAT(INTERMEDIATE_CHART_PERSONAL_EXPENSE,'_',USERSTAMP_ID));
		SET @CREATE_TEMP_CHARTS_PERSONAL_EXPENSE=(SELECT CONCAT('CREATE TABLE ',CHARTS_PERSONAL_EXPENSE_TEMPTBL,'(MONTH_YEAR varchar(50) DEFAULT NULL, BABY_EXPENSES DECIMAL(10, 2) DEFAULT 0,
		CAR_EXPENSES DECIMAL(10, 2) DEFAULT 0, CAR_LOAN DECIMAL(10, 2) DEFAULT 0,
		...
		BABY_EXPENSES DECIMAL(10, 2) DEFAULT 0, CAR_EXPENSES DECIMAL(10, 2) DEFAULT 0,CAR_LOAN DECIMAL(10, 2) DEFAULT 0,
		PERSONAL_EXPENSES DECIMAL(10, 2) DEFAULT 0,SORT_DATE DATE DEFAULT NULL)'));
