...
START TRANSACTION;
  ...
  IF (TO_DATE IS NOT NULL) THEN    
    ...
    SET FINAL_TO_DATE = CONCAT(TO_PERIOD_YEAR,'-',TO_PERIOD_MONTHNO,'-','31');  ELSE
    SET FINAL_TO_DATE = CONCAT(FROM_PERIOD_YEAR,'-',FROM_PERIOD_MONTHNO,'-','31');
  END IF;  
	SET @CREATE_TEMP_CHARTS_BIZ_EXPENSE_ALLUNIT=(SELECT CONCAT('CREATE TABLE ',CHARTS_BIZ_EXPENSE_ALLUNIT_TMPTBL,'(UNIT_NUMBER SMALLINT(4) UNSIGNED ZEROFILL,CAR_PARK DECIMAL(10,2),DIGITAL_VOICE DECIMAL(10,2),ELECTRICITY DECIMAL(10,2),FACILITY_USE DECIMAL(10,2),MOVE_IN_OUT DECIMAL(10,2),STARHUB DECIMAL(10,2),UNIT_EXPENSE DECIMAL(10,2))'));
	...
	SET @CREATE_TEMP_INTERMEDIATE_CHARTS_BIZ=(SELECT CONCAT('CREATE TABLE ',INTERMEDIATE_CHARTS_BIZ_EXPENSE_TEMPTBL,'(UNIT_NUMBER SMALLINT(4) UNSIGNED ZEROFILL,CAR_PARK DECIMAL(10,2),DIGITAL_VOICE DECIMAL(10,2),ELECTRICITY DECIMAL(10,2),FACILITY_USE DECIMAL(10,2),MOVE_IN_OUT DECIMAL(10,2),STARHUB DECIMAL(10,2),UNIT_EXPENSE DECIMAL(10,2))'));
