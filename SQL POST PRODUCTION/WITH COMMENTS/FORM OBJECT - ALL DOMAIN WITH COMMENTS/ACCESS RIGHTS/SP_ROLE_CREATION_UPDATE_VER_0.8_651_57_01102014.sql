...
DB_NAME VARCHAR(20),
OUT RC_FLAG INTEGER,
OUT TEMP_OUT_INSERT_MENU TEXT,
OUT TEMP_OUT_REMOVE_MENU TEXT,
OUT TEMP_OUT_INSERT_FILE TEXT,
OUT TEMP_OUT_REMOVE_FILE TEXT
)
BEGIN
...
IF (TEMP_INSERT_FILE IS NOT NULL) THEN
  SET @DROP_TEMP_INSERT_FILE=(SELECT CONCAT('DROP TABLE IF EXISTS ',TEMP_INSERT_FILE));
...
IF (TEMP_REMOVE_FILE IS NOT NULL) THEN
  SET @DROP_TEMP_REMOVE_FILE=(SELECT CONCAT('DROP TABLE IF EXISTS ',TEMP_REMOVE_FILE));
...
SET TEMP_OUT_INSERT_MENU=TEMP_INSERT_MENU;
...
SET TEMP_OUT_REMOVE_MENU=TEMP_REMOVE_MENU;
...
SET TEMP_OUT_INSERT_FILE=TEMP_INSERT_FILE;
...
SET TEMP_OUT_REMOVE_FILE=TEMP_REMOVE_FILE;
