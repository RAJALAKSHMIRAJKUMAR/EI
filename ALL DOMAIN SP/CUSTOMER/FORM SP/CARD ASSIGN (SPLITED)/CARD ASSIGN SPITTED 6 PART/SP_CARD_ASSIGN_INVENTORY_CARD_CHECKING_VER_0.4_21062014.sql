...
BEGIN
    ...
    BEGIN
    ROLLBACK;
	IF TEMP_CARD_ASSIGN_CHECKING IS NOT NULL THEN
	SET @DROP_TEMP_CARD_ASSIGN_CHECKING=(SELECT CONCAT('DROP TABLE IF EXISTS ',TEMP_CARD_ASSIGN_CHECKING));
    PREPARE DROP_TEMP_CARD_ASSIGN_CHECKING_STMT FROM @DROP_TEMP_CARD_ASSIGN_CHECKING;
    EXECUTE DROP_TEMP_CARD_ASSIGN_CHECKING_STMT;
	END IF;
    END;
    START TRANSACTION;
...
SET @DROP_TEMP_CARD_ASSIGN_CHECKING_=(SELECT CONCAT('DROP TABLE IF EXISTS ',TEMP_CARD_ASSIGN_CHECKING));
PREPARE DROP_TEMP_CARD_ASSIGN_CHECKING_STMT FROM @DROP_TEMP_CARD_ASSIGN_CHECKING_;
EXECUTE DROP_TEMP_CARD_ASSIGN_CHECKING_STMT; 
...
IF CARD_ASSIGN_FLAG!=' ' THEN
    SET FLAG=(SELECT CONCAT(CARD_ASSIGN_FLAG,'-','ACTIVE CARD SHOULD NOT BE ASSIGNED'));
