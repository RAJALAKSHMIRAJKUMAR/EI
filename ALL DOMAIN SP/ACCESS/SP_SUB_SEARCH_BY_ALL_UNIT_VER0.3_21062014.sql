-- version 0.3-->startdate:21/06/2014 ensdate:21/06/2014---issue no:817--desc:dropped temp table if rollback occur

-- > version 0.2-- >startdate:09/06/2014  enddate:09/06/2014 -- >issueno:566 comment:12 -- >desc:ADDED ROLLBACK AND COMMIT -- >doneby:SASIKALA

-- > version 0.1-- >startdate:02/06/2014  enddate:03/06/2014 -- >issueno:825 comment:129 -- >desc:SPLITTED INTO 3 PARTS -- >doneby:DHIVYA
...
BEGIN
ROLLBACK;
IF FINAL_TABLE_NAME IS NOT NULL THEN
