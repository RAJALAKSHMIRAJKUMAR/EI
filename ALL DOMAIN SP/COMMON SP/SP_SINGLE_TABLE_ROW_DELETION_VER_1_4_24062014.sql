-- VER 1.4 ISSUE:817 COMMENT #139 STARTDATE:24/06/2014 ENDDATE:24/06/2014 DESC:DROPED TEMP TABLES INSIDE ROLL BACK AND COMMIT DONE BY:DHIVYA.A
...
-- CONCATENATING EACH COLUMN NAME AND COLUMN VALUES
			...
			IF (@V_COLUMN_NAME='CUSTOMER_ID' AND V_COLUMN_VALUE!='null')THEN
