...
-- VER 0.3 ISSUE NO:817 COMMENT #35 STARTDATE:20/05/2014 ENDDATE:20/05/2014 DESC: DROP THE TEMP TABLES AND VIEWS. DONE BY:RAJA
...
BEGIN
 ...
 IF(INTERMEDIATE_UNIT_GROSS_NET_REVENUE_PERUNIT IS NOT NULL) THEN
 ...
 IF(CHARTS_GROSS_REVENUE_PERUNIT IS NOT NULL) THEN
  ...
  IF(UNIT_RENTAL_PERUNIT IS NOT NULL) THEN
   ...
   IF(CHARTS_BIZ_EXPENSE_PERUNIT IS NOT NULL) THEN
...
SELECT *FROM TEMP_CHARTS_UNIT_GROSS_AND_NET_REVENUE_PERUNIT20140520171953_1;
*/