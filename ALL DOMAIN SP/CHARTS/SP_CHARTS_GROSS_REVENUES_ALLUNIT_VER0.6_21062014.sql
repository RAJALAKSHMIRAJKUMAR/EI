-- VER 0.6 TRACKER NO:817 COMMENT #139 STARTDATE:21/06/2014 ENDDATE:21/06/2014 DESC: DROPPING TEMP TABLES IF ROLLBACK OCCURS DONE BY:SASIKALA
-- VER 0.5 TRACKER NO:566 COMMENT #12 STARTDATE:09/06/2014 ENDDATE:09/06/2014 DESC: ADDED ROLLBACK AND COMMIT DONE BY:SASIKALA
...
BEGIN
 ROLLBACK;
  IF(INTERMEDIATE_GROSS_REVENUE_ALLUNIT IS  NOT NULL) THEN
...
END;
/*
CALL SP_CHARTS_GROSS_REVENUE_ALLUNIT('November-2013','January-2014','EXPATSINTEGRATED@GMAIL.COM',@TEMP_CHARTS_GROSS_REVENUE_ALLUNIT);
SELECT @TEMP_CHARTS_GROSS_REVENUE_ALLUNIT;
SELECT * FROM TEMP_CHARTS_GROSS_REVENUE_ALLUNIT20140621174254_2;
*/