...
--   TEMP TABLE NAME END     
  ...
  -- CREATING MAIN TEMP TABLE FOR FINAL OUTPUT
    ...
    SET @CREATE_TEMP_CHARTS_BIZ_EXPENSE=(SELECT CONCAT('CREATE TABLE ',TEMP_MAIN_CHARTS_BIZ_EXPENSE,'(MONTH_YEAR VARCHAR(20),CAR_PARK DECIMAL(20,2),DIGITAL_VOICE DECIMAL(20,2),ELECTRICITY DECIMAL(20,2),FACILITY_USE DECIMAL(20,2),MOVE_IN_OUT DECIMAL(20,2),STARHUB DECIMAL(20,2),UNIT_EXPENSE DECIMAL(20,2))'));
  ...
  -- CREATING INTERMEDIATE TEMP TABLE 
      ...
      SET @CREATE_TEMP_INTERMEDIATE_CHARTS_BIZ=(SELECT CONCAT('CREATE TABLE ',INTERMEDIATE_BIZ_EXPENSE_TEMPTBL,'(MONTH_YEAR VARCHAR(20),CAR_PARK DECIMAL(7,2),DIGITAL_VOICE DECIMAL(7,2),ELECTRICITY DECIMAL(7,2),FACILITY_USE DECIMAL(7,2),MOVE_IN_OUT DECIMAL(7,2),STARHUB DECIMAL(7,2),UNIT_EXPENSE DECIMAL(7,2), DATE DATE)'));
