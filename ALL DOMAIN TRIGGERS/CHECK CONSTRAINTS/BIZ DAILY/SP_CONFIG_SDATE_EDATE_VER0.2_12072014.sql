-- version:0.2 --sdate:12-07-2014 --edate:12-07-2014 --issue:593 --commentno#255 --desc:ADDED INVOICEDATE ARGUMENT IN CONFIG SP --doneby:DHIVYA
-- version:0.1 --sdate:11-07-2014 --edate:11-07-2014 --issue:593 --commentno#255 --desc:CONFIG SP FOR GETTING UD_STARTDTE-CONFIGMONTH AND UD_ENDDATE+CONFIGMONTH --doneby:BHAVANI.R
...
END WHILE;
IF E_CONFIGDATE>CURDATE() THEN
SET INVOICE_DATE=CURDATE();
ELSE
SET INVOICE_DATE=E_CONFIGDATE;
END IF;
END;