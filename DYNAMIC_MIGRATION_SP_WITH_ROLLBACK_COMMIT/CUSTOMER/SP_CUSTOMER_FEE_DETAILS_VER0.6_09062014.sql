-- version:0.6 -- sdate:09/06/2014 -- edate:09/06/2014 -- issue:566 -- COMMENT NO:12 --desc:IMPLEMENTED ROLL BACK AND COMMIT --doneby:DHIVYA.A
-- ver 0.5 sdate:21/03/2014 edate:27/03/2014 issue no:765 desc:changed customer_fee_details table dynamically done by:DHIVYA
...
BEGIN
	...
	EXECUTE LOGINID;
	-- DROP QUERY FOR CUSTOMER_FEE_DETAILS
	...
	-- MIN ID FROM TEMP_CUSTOMER_TERMINATION_DETAILS
