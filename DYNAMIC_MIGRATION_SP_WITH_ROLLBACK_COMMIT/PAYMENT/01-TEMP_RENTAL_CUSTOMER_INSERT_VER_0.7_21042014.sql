...
CREATE TABLE TEMP_DURATION_PAYMENT_PART1(ID INTEGER PRIMARY KEY AUTO_INCREMENT,SPLITTING_DURATION2 TIME);
INSERT INTO TEMP_DURATION_PAYMENT_PART1(SPLITTING_DURATION2)VALUES(DURATION);
COMMIT;
END;
